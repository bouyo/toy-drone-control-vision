#ifndef _ROS_morus_uav_ros_msgs_MmPosition_h
#define _ROS_morus_uav_ros_msgs_MmPosition_h
...
namespace morus_uav_ros_msgs
{
  ...
  class MmPosition : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "morus_uav_ros_msgs/MmPosition"; };
