#ifndef _ROS_planning_msgs_PointCloudWithPose_h
#define _ROS_planning_msgs_PointCloudWithPose_h
...
namespace planning_msgs
{
  ...
  class PointCloudWithPose : public ros::Msg
  {
    ...
    const char * getType(){ return "planning_msgs/PointCloudWithPose"; };
