#ifndef _ROS_planning_msgs_PolynomialSegment4D_h
#define _ROS_planning_msgs_PolynomialSegment4D_h
...
namespace planning_msgs
{
  ...
  class PolynomialSegment4D : public ros::Msg
  {
    ...
    const char * getType(){ return "planning_msgs/PolynomialSegment4D"; };
